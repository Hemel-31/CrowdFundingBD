...
import { CrowdFundingContext } from '../Context/CrowdFundingContext'; // Correct path

const PopUp = ({ setOpenModel, donate, donateFunction, getDonations }) => {
  const [amount, setAmount] = useState('');
  const [allDonationData, setAllDonationData] = useState([]);
  const { deleteCampaign, currentAccount } = useContext(CrowdFundingContext);
  ...
  const isOwner = donate.owner.toLowerCase() === currentAccount.toLowerCase();
