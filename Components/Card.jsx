    ...
    <div className="max-auto px-8 py-10">
      ...
      <div className="grid gap-5 grid-cols-3 max-w-full">
        {allcampaign?.map((campaign,i)=>(
          <div
            ...
            className="cursor-pointer border overflow-hidden transition-shadow duration-300 bg-white rounded">
              <img src="https://i.pinimg.com/originals/de/ff/e4/deffe42dd0ea88078c939d05d1e2a781.jpg" className="object-cover w-full h-64 rounded" alt="" />
        ...
        {/* {searchResults?.map((campaign, i) => (
          ...
          >
            <img
              src="https://i.pinimg.com/originals/de/ff/e4/deffe42dd0ea88078c939d05d1e2a781.jpg"
              className="object-cover w-full h-64 rounded"
              alt=""
            />
            <div className="py-5 pl-2">
              <p className="mb-2 text-xs font-semibold text-gray-600 uppercash">
